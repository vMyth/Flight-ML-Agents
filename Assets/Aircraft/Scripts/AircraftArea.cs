...
namespace Aircraft
{
    ...
    {
        [Tooltip("The path the race will take place in")]
        ...
        [Tooltip("If true, enables training mode")]
        ...
        public void ResetAgenntPosition(AircraftAgent agent, bool randomize = false)
        {
            if (randomize)
            {
